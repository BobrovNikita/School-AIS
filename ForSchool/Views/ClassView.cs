...
{
    public partial class ClassView : Form, IClassView
    {
        ...
        public int Year 
        {
            get
            {
                if (!int.TryParse(YearTxt.Text, out _))
                {
                    return 0;
                }
                else
                {
                    return int.Parse(YearTxt.Text);
                }
            }
            set
            {
        ...
        private static ClassView? instance;

        public static ClassView GetInstance(Form parentContainer)
        {
